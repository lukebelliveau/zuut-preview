...
export const handleDeleteOnKeyDown = (e: React.KeyboardEvent<HTMLSpanElement>, store: AppStore) => {
...
export const handleEscOnKeyDown = (e: React.KeyboardEvent<HTMLSpanElement>, store: AppStore) => {
  if (e.key === 'Escape') {
    store.dispatch(unselectAll());
    e.preventDefault();
  }
