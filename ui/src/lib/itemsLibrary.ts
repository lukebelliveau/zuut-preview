...
const ItemsLibrary: IItemGroup[] = [
  ...
  },
  {
    itemGroup: 'misc',
    items: [
      new MiscItem('Seedling Trays', undefined, 'B08SBN1YJD'),
      new MiscItem('Seedling Heating Map', undefined, 'B08SBN1YJD'),
      new MiscItem('Magnifier', undefined, 'B08SBN1YJD'),
      new MiscItem('Nutrients', undefined, 'B08SBN1YJD'),
      new MiscItem('pH Tester', undefined, 'B08SBN1YJD'),
      new MiscItem('pH Up/Down', undefined, 'B08SBN1YJD'),
      new MiscItem('Extension Cord', undefined, 'B08SBN1YJD'),
      new MiscItem('Measuring Spoons', undefined, 'B08SBN1YJD'),
      new MiscItem('Pipettes', undefined, 'B08SBN1YJD'),
      new MiscItem('Syringes', undefined, 'B08SBN1YJD'),
      new MiscItem('Eye Protection', undefined, 'B08SBN1YJD'),
      new MiscItem('Zip Ties', undefined, 'B08SBN1YJD'),
      new MiscItem('Extension Cords', undefined, 'B08SBN1YJD'),
      new MiscItem('Pruning Snips', undefined, 'B08SBN1YJD'),
      new MiscItem('Vented Cloning Dome', undefined, 'B08SBN1YJD'),
      new MiscItem('Wet Vac', undefined, 'B08SBN1YJD'),
      new MiscItem('Humidity Packs', undefined, 'B08SBN1YJD'),
      new MiscItem('Power Strip', undefined, 'B08SBN1YJD'),
      new MiscItem('Hygrometer', undefined, 'B08SBN1YJD'),
      new MiscItem('Thermometer', undefined, 'B08SBN1YJD'),
      new MiscItem('Insect Buzzers', undefined, 'B08SBN1YJD'),
      new MiscItem('Fly Stickers', undefined, 'B08SBN1YJD'),
      new MiscItem('Power timer', undefined, 'B08SBN1YJD'),
      new MiscItem('Trimmer', undefined, 'B08SBN1YJD'),
      new MiscItem('Sprayer', undefined, 'B08SBN1YJD'),
      new MiscItem('Irrigation System', undefined, 'B08SBN1YJD'),
      new MiscItem('Watering globes', undefined, 'B08SBN1YJD'),
      new MiscItem('Bamboo Stick', undefined, 'B08SBN1YJD'),
      new MiscItem('Saucers', undefined, 'B08SBN1YJD'),
      new MiscItem('Trays', undefined, 'B08SBN1YJD'),
      new MiscItem('Pot holders', undefined, 'B08SBN1YJD'),
      new MiscItem('Soil', undefined, 'B08SBN1YJD'),
      new MiscItem('Binder clips', undefined, 'B08SBN1YJD'),
      new MiscItem('Plant ties', undefined, 'B08SBN1YJD'),
      new MiscItem('Seeds', undefined, 'B08SBN1YJD'),
      new MiscItem('Plant Yoyos', undefined, 'B08SBN1YJD'),
      new MiscItem('Coco Coir', undefined, 'B08SBN1YJD'),
      new MiscItem('Rope Ratchets', undefined, 'B08SBN1YJD'),
      new MiscItem('Water Pump', undefined, 'B08SBN1YJD'),
      new MiscItem('Hose', undefined, 'B08SBN1YJD'),
      new MiscItem('Spray Handle', undefined, 'B08SBN1YJD'),
      new MiscItem('Air pump', undefined, 'B08SBN1YJD'),
      new MiscItem('Air stone', undefined, 'B08SBN1YJD'),
      new MiscItem('Starter Plugs', undefined, 'B08SBN1YJD'),
    ],
  },
];
