...
import { zoom as zoomPlayground } from '../../redux/features/playgrounds/playgroundSlice';
...
import { AppStore, useDispatch } from '../../redux/store';
...
export default function ShowPlayground({
  ...
  return (
    <TopLevelErrorBoundary
      ...
      errorName={'ShowPlayground Error'}
    >
      <Fragment>
        <div
          role="presentation"
        ...
        >
          <div
            ...
            style={{ height: '100%', width: '100%' }}
          >
            <div style={{ paddingTop: HEADER.H_DASHBOARD_DESKTOP_OFFSET }}>
              <Stage
                key={v4()}
                ref={stageRef}
